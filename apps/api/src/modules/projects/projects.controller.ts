...
export class ProjectsController {
  ...
  async archive(
    ...
    const data = await this.projectsService.archive(
      organizationId,
      projectId,
      user,
    );
  ...
  async restore(
    ...
    const data = await this.projectsService.restore(
      organizationId,
      projectId,
      user,
    );
  ...
  async projectAccess(
    ...
    const data = await this.projectsService.getProjectAccess(
      organizationId,
      user,
    );
  ...
  async findOrganizationProjectAssignments(
    ...
    const data = await this.projectsService.findOrganizationProjectAssignments(
      organizationId,
      user,
    );
    return {
      success: true,
      message: "Organization project assignments retrieved",
      data,
    };
  }
  ...
  async saveMemberProjectAssignments(
    ...
    @Body() dto: SaveMemberProjectAssignmentsDto,
    @CurrentUser() user: AuthenticatedUser,
  ) {
    const data = await this.projectsService.saveMemberProjectAssignments(
      organizationId,
      memberId,
      dto,
      user,
    ...
    return {
      success: true,
      message: "Member project assignments saved",
      data,
    };
  }
  ...
  @Put("projects/:projectId/member-assignments")
  async saveProjectMemberAssignments(
    @Param("organizationId") organizationId: string,
    @Param("projectId") projectId: string,
    @Body() dto: SaveProjectMemberAssignmentsDto,
    @CurrentUser() user: AuthenticatedUser,
  ) {
    const data = await this.projectsService.saveProjectMemberAssignments(
      organizationId,
      projectId,
      dto,
      user,
    ...
    return {
      success: true,
      message: "Project member assignments saved",
      data,
    };
  }
