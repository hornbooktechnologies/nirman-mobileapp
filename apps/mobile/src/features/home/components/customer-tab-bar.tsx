...
type CustomerNavigationDefinition = Omit<
...
const organizationNavigation: readonly CustomerNavigationDefinition[] = [
  {
    ...
    titleKey: "items.notifications.title",
  ...
  },
  {
    ...
    titleKey: "items.members.title",
    descriptionKey: "items.members.description",
  ...
  {
    key: "work-calendar",
    labelKey: "items.calendar.title",
    titleKey: "items.calendar.title",
    descriptionKey: "items.calendar.description",
    icon: "calendar-month-outline",
    href: "/(app)/work-calendar",
...
const customerNavigation: readonly CustomerNavigationDefinition[] = [
  {
    key: "home",
    labelKey: "tabs.home",
    titleKey: "items.home.title",
    descriptionKey: "items.home.description",
    icon: "home-outline",
    href: "/(app)/dashboard",
  },
  {
    ...
    descriptionKey: "items.team.description",
  ...
  {
    key: "project",
    labelKey: "tabs.project",
    titleKey: "items.project.title",
    descriptionKey: "items.project.description",
  ...
  {
    key: "workers",
    labelKey: "items.workers.title",
    titleKey: "items.workers.title",
    descriptionKey: "items.workers.description",
  ...
  },
  {
    ...
    titleKey: "items.attendance.title",
  ...
  {
    key: "wages",
    labelKey: "items.wages.title",
    titleKey: "items.wages.title",
    descriptionKey: "items.wages.description",
    icon: "cash-multiple",
    href: "/(app)/wages",
    permission: "wages:read",
  },
  {
    key: "kharchi",
    labelKey: "items.kharchi.title",
    titleKey: "items.kharchi.title",
    descriptionKey: "items.kharchi.description",
    icon: "cash-minus",
    href: "/(app)/kharchi",
  ...
  {
    key: "materials",
    labelKey: "items.materials.title",
    titleKey: "items.materials.title",
  ...
  {
    key: "expenses",
    labelKey: "items.expenses.title",
    titleKey: "items.expenses.title",
    descriptionKey: "items.expenses.description",
  ...
  {
    key: "progress",
    labelKey: "items.progress.title",
    titleKey: "items.progress.title",
    descriptionKey: "items.progress.description",
  ...
  {
    key: "gallery",
    labelKey: "items.gallery.title",
    titleKey: "items.gallery.title",
    descriptionKey: "items.gallery.description",
  ...
  {
    key: "sales",
    labelKey: "items.sales.title",
    titleKey: "items.sales.title",
    descriptionKey: "items.sales.description",
  ...
  },
  {
    key: "menu",
    labelKey: "tabs.menu",
    titleKey: "items.menu.title",
    descriptionKey: "items.menu.description",
    icon: "menu",
    href: "/(app)/menu",
  },
];
...
function localizeNavigationItem(
  item: CustomerNavigationDefinition,
...
export function visibleOrganizationNavigation(
  session: MobileSession | null,
  t: TFunction<"navigation">,
) {
  const projectPermissions = getActiveProjectPermissions(session);
  return organizationNavigation
    .filter(
      (item) =>
        ...
        projectPermissions.includes(item.permission),
    )
    .map((item) => localizeNavigationItem(item, t));
}
...
export function CustomerTabBar({ activeKey }: { activeKey: string }) {
  ...
  return (
    <FloatingTabBar
      ...
      tabs={tabs}
      onChange={(key) => {
        const item = primaryItems.find((candidate) => candidate.key === key);
